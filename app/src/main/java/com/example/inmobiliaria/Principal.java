...
public class Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title_header = haderView.findViewById(R.id.title_header);
        TextView email_header = haderView.findViewById(R.id.email_header);
        title_header.setText(nombre);
